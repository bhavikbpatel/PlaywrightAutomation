...
export class CheckOutPage {
     ...
     */
    async enterDetails(countryName:string) 
    { 
     ...
     */
    async verifyUserOnCheckOutPage(username:string)
    {
        expect(this.userEmail.first()).toHaveText(username);
    }
}
module.exports = { CheckOutPage }; // Export the CheckOutPage class for use in tests